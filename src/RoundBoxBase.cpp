...
namespace BlendInt {
	...
	const float RoundBoxBase::cornervec[WIDGET_CURVE_RESOLU][2] = {
		{0.0, 0.0}, {0.195, 0.02}, {0.383, 0.067},
		{0.55, 0.169}, {0.707, 0.293}, {0.831, 0.45},
		{0.924, 0.617}, {0.98, 0.805}, {1.0, 1.0}
	};

	const float RoundBoxBase::jit[WIDGET_AA_JITTER][2] = {
	...
	VerticesSum RoundBoxBase::generate_vertices(const Size* size,
			float border,
			int round_type,
			float radius,
