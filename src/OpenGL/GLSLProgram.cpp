...
//			DBG_PRINT_MSG("GL Program %d is not a program object, or not a program object, or has not been successfully linked", m_id);
//			break;
//		}
//
//		default:
...
//
//			DBG_PRINT_MSG("GL Program %d is not a value generated by OpenGL", m_id);
//			break;
//		}
//
//		case GL_INVALID_OPERATION: {
//			DBG_PRINT_MSG("GL Program %d is not a program object, or has not been successfully linked", m_id);
//			break;
//		}
//
//		default:
...
//		}
	...
	void GLSLProgram::SetVertexAttrib1f(GLuint index, GLfloat v0)
	{
		...
		case GL_INVALID_VALUE: {
			DBG_PRINT_MSG("%s", "Get GL_INVALID_VALUE error, check the OpenGL glVertexAttrib manual");
			break;
		}

		case GL_INVALID_ENUM: {
			DBG_PRINT_MSG("%s", "Get GL_INVALID_ENUM error, check the OpenGL glVertexAttrib manual");
			break;
		}
