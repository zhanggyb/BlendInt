...
namespace BlendInt {
	...
	void HBox::FillSubWidgetsProportionally (int x, int y, int width,
	...
	void HBox::Align (int y, int height, int alignment, const std::deque<int>* unexpandable_preferred_heights)
	{
