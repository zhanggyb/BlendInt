...
namespace BlendInt {
	...
	ResponseType NodeView::Draw(Profile& profile)
	{
		...
		glUniform3f(Shaders::instance->location(Stock::WIDGET_TRIANGLE_POSITION), (float) position().x() + 25, (float) position().y() + 425, 0.f);
		glBindVertexArray(vaos_[2]);
		...
		glUniform1i(Shaders::instance->location(Stock::WIDGET_TRIANGLE_ANTI_ALIAS), 0);
		glUniform3f(Shaders::instance->location(Stock::WIDGET_TRIANGLE_POSITION), (float) position().x() + 300, (float) position().y() + 450, 0.f);
		glVertexAttrib4f(Shaders::instance->location(Stock::WIDGET_TRIANGLE_COLOR), 1.f, 0.2f, 0.2f, 0.9f);
		glBindVertexArray(vaos_[3]);
		glDrawArrays(GL_TRIANGLE_STRIP, 0, 4);
		...
		glVertexAttrib4f(Shaders::instance->location(Stock::WIDGET_TRIANGLE_COLOR), 0.f, 0.f, 1.f, 1.f);
