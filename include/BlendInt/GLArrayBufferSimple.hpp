...
#ifndef _BLENDINT_GLARRAYBUFFERSIMPLE_HPP_
#define _BLENDINT_GLARRAYBUFFERSIMPLE_HPP_
...
namespace BlendInt {
	 ...
	 * @ingroup opengl
	 */
	class GLArrayBufferSimple: public AbstractGLBuffer
	{
	public:

		GLArrayBufferSimple ();

		virtual ~GLArrayBufferSimple ();
...
#endif /* _BLENDINT_GLARRAYBUFFERSIMPLE_HPP_ */
