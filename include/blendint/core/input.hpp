...
namespace BlendInt {
  ...
  enum MouseAction
  {
    ...
    MouseRelease = 0, /* GLFW_RELEASE */                  //!< PerformMousePress
    MousePress, /* GLFW_PRESS */     //!< PerformMouseRelease
    MouseMove /* GLFW_REPEAT */       //!< PerformMouseMove
  };

  enum MouseButton
  {
    MouseButtonNone = -1, MouseButtonLeft = 0, /* 0 GLFW_MOUSE_BUTTON_1 */
  ...
  enum KeyAction
  {
    KeyNone = -1, KeyPress = 0, /* GLFW_RELEASE */
