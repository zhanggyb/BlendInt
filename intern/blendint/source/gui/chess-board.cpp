...
: vao_(0)
{
  ...
  GLfloat vertices[] = {
      ...
      (float)w, 0.f,       1.f * w / (kCellWidth * 2), 0.f,   // right-bottom
      0.f, (float)h,       0.f, 1.f * h / (kCellHeight * 2),   // left-top
      (float)w, (float)h,  1.f * w / (kCellWidth * 2), 1.f * h / (kCellHeight * 2)  // right-top
  };
