...
namespace BlendInt {
  ...
  const char* Shaders::widget_text_vertex_shader = "#version 330\n"
  ...
  const char* Shaders::widget_text_fragment_shader = "#version 330\n"
      "in vec2 uv;"
  ...
  const char* Shaders::widget_triangle_vertex_shader = "#version 330\n"
      ""
  ...
  const char* Shaders::widget_triangle_geometry_shader = "#version 330\n"
      ""
      "layout (triangles) in;"
  ...
  const char* Shaders::widget_triangle_fragment_shader = "#version 330\n"
      ""
  ...
  const char* Shaders::widget_simple_triangle_vertex_shader = "#version 330\n"
      ""
  ...
  const char* Shaders::widget_outer_vertex_shader = "#version 330\n"
      ""
      "layout(location=0) in vec2 aCoord;"
      ""
      "void main(void) {"
  ...
  const char* Shaders::widget_outer_geometry_shader = "#version 330\n"
      ""
      "layout (triangles) in;"
      "layout (triangle_strip, max_vertices = 24) out;"
      ""
  ...
  const char* Shaders::widget_outer_fragment_shader = "#version 330\n"
      ""
      "uniform vec4 uColor;"
      "out vec4 FragmentColor;"
      ""
  ...
  const char* Shaders::widget_image_vertex_shader = "#version 330\n"
      "layout(location = 0) in vec2 aCoord;"
  ...
  const char* Shaders::widget_image_fragment_shader = "#version 330\n"
      "in vec2 f_texcoord;"
      "uniform sampler2D uTexture;"
      "uniform int uGamma = 0;"
      "out vec4 FragmentColor;"
  ...
  const char* Shaders::widget_line_vertex_shader = "#version 330\n"
      ""
      "layout (location=0) in vec3 aCoord;"
      "layout (std140) uniform WidgetMatrices {"
      "	mat4 projection;"
  ...
  const char* Shaders::widget_shadow_vertex_shader = "#version 330\n"
      ""
      "layout(location=0) in vec3 aCoord;"
      "out float gAlpha;"
      ""
  ...
  const char* Shaders::widget_shadow_geometry_shader = "#version 330\n"
      ""
      "layout (triangles) in;"
      "layout (triangle_strip, max_vertices = 24) out;"
      "in float gAlpha[];"
  ...
  const char* Shaders::widget_shadow_fragment_shader = "#version 330\n"
      ""
      "in float fAlpha;"
      "out vec4 FragmentColor;"
      "uniform vec2 uVP;"
  ...
  const char* Shaders::frame_inner_vertex_shader = "#version 330\n"
      ""
      "layout(location=0) in vec3 aCoord;"
  ...
  const char* Shaders::frame_outer_vertex_shader = "#version 330\n"
      ""
      "layout(location=0) in vec2 aCoord;"
      ""
      "void main(void) {"
  ...
  const char* Shaders::frame_outer_geometry_shader = "#version 330\n"
      ""
      "layout (triangles) in;"
      "layout (triangle_strip, max_vertices = 24) out;"
      ""
  ...
  const char* Shaders::frame_image_vertex_shader = "#version 330\n"
      "layout(location = 0) in vec2 aCoord;"
      "layout(location = 1) in vec2 aUV;"
      "out vec2 fTexcoord;"
      ""
  ...
  const char* Shaders::frame_image_fragment_shader = "#version 330\n"
      "in vec2 fTexcoord;"
      "uniform sampler2D uTexture;"
      "uniform int uGamma = 0;"
      "out vec4 FragmentColor;"
  ...
  const char* Shaders::frame_shadow_vertex_shader = "#version 330\n"
      ""
      "layout(location=0) in vec3 aCoord;"
      "out float gAlpha;"
      ""
  ...
  const char* Shaders::frame_shadow_geometry_shader = "#version 330\n"
      ""
      "layout (triangles) in;"
      "layout (triangle_strip, max_vertices = 24) out;"
      "in float gAlpha[];"
  ...
  void Shaders::GetWidgetModelMatrix (glm::mat3& matrix)
  {
    /*
     ui_matrix_->bind();
     float* buf_p = (float*)ui_matrix_->map(GL_READ_ONLY);
  ...
  bool Shaders::Setup ()
  {
    ...
    glUniformBlockBinding(widget_inner_program_->id(), block_index,
                          widget_matrices_ubo_binding_point_);

    glGetActiveUniformBlockiv(widget_inner_program_->id(), block_index,
    ...
    for (int i = 0; i < 3; i++) {
      ...
      memcpy(
          buf_p + widget_matrices_ubo_offset_[ModelIndex]
              + i * sizeof(glm::vec4),
    ...
    glUniformBlockBinding(frame_inner_program_->id(), block_index,
                          frame_matrices_ubo_binding_point_);
    ...
    for (int i = 0; i < 3; i++) {
      line = glm::vec4(model[i], 0.f);
      memcpy(
          buf_p + frame_matrices_ubo_offset_[ModelIndex]
              + i * sizeof(glm::vec4),
          glm::value_ptr(line), sizeof(glm::vec4));
    }
  ...
  bool Shaders::SetupWidgetInnerProgram ()
  {
    ...
    locations_[WIDGET_INNER_COORD] =
        widget_inner_program_->GetAttributeLocation("aCoord");
  ...
  bool Shaders::SetupWidgetImageProgram ()
  {
    ...
    locations_[WIDGET_IMAGE_COORD] =
        widget_image_program_->GetAttributeLocation("aCoord");
    locations_[WIDGET_IMAGE_UV] = widget_image_program_->GetAttributeLocation(
        "aUV");
    locations_[WIDGET_IMAGE_POSITION] =
        widget_image_program_->GetUniformLocation("uPosition");
    locations_[WIDGET_IMAGE_ROTATION] =
        widget_image_program_->GetUniformLocation("uRotation");
    locations_[WIDGET_IMAGE_TEXTURE] =
        widget_image_program_->GetUniformLocation("uTexture");
  ...
  bool Shaders::SetupFrameShadowProgram ()
  {
    ...
    locations_[FRAME_SHADOW_COORD] =
        frame_shadow_program_->GetAttributeLocation("aCoord");
    locations_[FRAME_SHADOW_POSITION] =
        frame_shadow_program_->GetUniformLocation("uPosition");
