...
namespace BlendInt {
	...
	ResponseType BrightnessSlider::Draw (AbstractWindow* context)
	{
...
//						12, 0.0));
	...
	void BrightnessSlider::InitializeBrightnessSlider()
	{
		...
		glVertexAttribPointer(AbstractWindow::shaders->location(Shaders::WIDGET_OUTER_COORD), 2, GL_FLOAT, GL_FALSE, 0, 0);
