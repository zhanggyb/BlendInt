                        ...
                        float scale_y) const
{
  ...
  glUniform2f(
      AbstractWindow::shaders()->location(Shaders::FRAME_SHADOW_POSITION), x,
      y);
  ...
  glUniform1i(
      AbstractWindow::shaders()->location(Shaders::FRAME_SHADOW_ANTI_ALIAS), 0);
  i++;
...
void FrameShadow::PerformSizeUpdate (int width, int height)
{
